...
public class BusinessChoiceFireFoxTest {
  ...
  public void f(String url) {
	    ...
	    WebElement Element3 = driver.findElement(By.xpath("//p[@class='hSeven all-fields-required-message ng-binding']"));
	...
	public void screenShot(ITestResult result) {
		...
		if(ITestResult.FAILURE==result.getStatus()){
			...
			try{
				 ...
				 FileHandler.copy(source, new File("./ScreenShots/"+result.getName()+"firefox"+".png"));
